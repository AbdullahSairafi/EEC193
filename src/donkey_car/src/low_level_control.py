...
class DkLowLevelCtrl():
    def __init__(self):
        ...
        self.actuators = {}
        self.actuators['throttle']  = ServoConvert(id=1, center_value=310, range=100)
        self.actuators['steering']  = ServoConvert(id=2, center_value=320, direction=-1) #-- positive left
